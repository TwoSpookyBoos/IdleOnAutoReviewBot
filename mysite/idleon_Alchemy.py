...
def setAlchemyP2W(inputJSON, playerCount):
    ...
    if highestAlchemyLevel >= 120 and p2wSum >= p2wTrueMax:
        advice_alchemyP2WSums = "You've purchased all " + str(p2wTrueMax) + " static upgrades in Alchemy-P2W, including 4th liquid! You for real real best now <3"
    elif highestAlchemyLevel < 120 and p2wSum >= p2wEasyMax:
        advice_alchemyP2WSums = "You've purchased all " + str(p2wEasyMax) + " easy static upgrades in Alchemy. Keep an eye out for the 4th liquid that unlocks at 120 Alchemy. You best until then <3"
    else:
        advice_alchemyP2WSums = "You've purchased " + str(p2wSum) + "/" + str(p2wEasyMax) + " easy upgrades in Alchemy. Keep an eye out for the 4th liquid that unlocks at 120 Alchemy. Try to finish the rest before Mid W5!"
