...
def setWorshipPrayersProgressionTier(inputJSON, progressionTiers):
    ...
    advice_WorshipPrayersCombined = ["Best Worship-Prayers tier met: " + str(overall_WorshipPrayersTier) + "/" + str(progressionTiers[-2][-0]) + ". Recommended Worship-Prayers actions:",advice_WorshipPrayers,advice_IgnorrablePrayers]
