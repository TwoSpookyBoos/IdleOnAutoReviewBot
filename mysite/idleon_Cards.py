...
def getCardSetReview(inputJSON):
    ...
    cardRequirementsDict = {
        ...
        "Spirited Valley": {
            ...
            "w6d1": ["w6d1", 900, 2700, 4500, 14400, 413100],
            "w6d2": ["w6d2", 1300, 3900, 6500, 20800, 596700],
            "w6d3": ["Samurai Guardians", 2500, 7500, 12500, 40000, 1147500],
            "Crystal5": ["W6-Crystal", 5000, 15000, 25000, 80000, 2295000]
        },
        "Dungeons": {
        ...
        "Bosses n Nightmares": {
            ...
            "Boss6A": ["W6Normal", 6, 18, 30, 96, 2754],
            "Boss6B": ["W6Chaotic", 9, 27, 45, 144, 4131],
            "Boss6C": ["W6Nightmare", 13, 39, 65, 208, 5967],
        },
        "Events": {
