...
# The formula including this is buried. Search for `Seraph_Cosmos`. It's the `Math.min` that contains the Tesseract Upgrade and "SummoningLevel / 20"
seraph_max = 5  #Last updated in v2.528.0
...
# `StatueInfo = function` in source. Last updated in v2.528.0
