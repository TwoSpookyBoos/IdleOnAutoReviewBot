...
gem_shop_dict = {
    ...
    'Pristine Charm': 136,
    'Shroom Familiar': 137,
    'Novelty Jade Coins': 10,  # 'Sand of Time': 138,
    'Instagrow Generator': 139,
    'Life Refill': 140,
    'King Of All Winners': 11,  # 'Compost Bag': 141,
    'Summoner Stone': 142,
...
def get_gem_shop_bonus_section_name(bonus_name: str) -> str:
    match bonus_name:
        ...
        case 'Plot of Land' | 'Pristine Charm' | 'Shroom Familiar' | 'Sand of Time' | 'Instagrow Generator' | 'Life Refill' | 'Compost Bag' | 'Summoner Stone' | 'Novelty Jade Coins' | 'King Of All Winners':
            return "W6"
