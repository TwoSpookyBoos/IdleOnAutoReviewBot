...
vials_considered_unmaxable = ['Poison Froge', 'BobJoePickle', 'BallJoePickle']
max_maxable_vials = max_index_of_vials - len(vials_considered_unmaxable)

# `AlchemyVialQTYreq` in source (has more entries than possible levels, cut off accordingly). Last updated in v2.528.0
# Set the first element (Level 0 -> Level 1) to 1 so we can set it as a `goal` in Advices
vial_costs = [1, 100, 1e3, 2500, 1e4, 5e4, 1e5, 5e5, 1000001, 5e6, 25e6, 1e8, 1e9]
...
# `SigilDesc = function` in source. Last updated in v2.528.0
sigils_data = ["BIG_MUSCLE 2 100 10 20 filler Boosts_base_STR_by_+{ 50000 40 250000 100 10000000 200".split(" ",),"PUMPED_KICKS 3 150 10 20 filler Boosts_base_AGI_by_+{ 60000 40 300000 100 20000000 200".split(" ",),"ODD_LITEARTURE 5 200 10 20 filler Boosts_base_WIS_by_+{ 70000 40 400000 100 30000000 200".split(" ",),"GOOD_FORTUNE 8 300 10 20 filler Boosts_base_LUK_by_+{ 90000 40 500000 100 50000000 200".split(" ",),"PLUNGING_SWORD 15 700 75 225 filler Boosts_base_damage_by_+{ 100000 1000 600000 5000 60000000 10000".split(" ",),"WIZARDLY_HAT 24 1250 10 20 filler Boosts_Mana_Regeneration_by_+{%_both_inside_and_outside_of_dungeon 130000 30 700000 50 100000000 60".split(" ",),"ENVELOPE_PILE 60 2500 12 25 filler Decreases_the_cost_of_upgrading_stamp_MAX_LEVELS_by_-{% 160000 40 1000000 65 250000000 75".split(" ",),"SHINY_BEACON 120 4000 1 2 filler The_first_{_monster_kills_every_day_will_spawn_a_Crystal_Mob 200000 5 1400000 10 70000000 12".split(" ",),"METAL_EXTERIOR 250 7000 6 12 filler Boosts_defence_by_nothing._Also_gives_+{%_Class_EXP 240000 20 1700000 50 200000000 70".split(" ",),"TWO_STARZ 500 10000 10 25 filler Gives_+{_Star_Talent_points_to_spend_as_you_wish 280000 45 2200000 100 300000000 125".split(" ",),"PIPE_GAUGE 700 12000 10 20 filler Increases_the_speed_of_refinery_cycles_by_+{% 320000 30 2600000 60 600000000 75".split(" ",),"TROVE 1300 14000 10 20 filler Boosts_drop_rate_by_+{% 400000 30 3000000 100 1250000000 150".split(" ",),"PEA_POD 2100 15000 25 50 filler All_sigils_charge_{%_faster_than_normal 420000 100 3500000 450 2500000000.0 600".split(" ",),"TUFT_OF_HAIR 3000 25000 3 6 filler Boosts_movement_speed_by_+{%_if_under_175% 450000 10 4300000 15 6000000000.0 20".split(" ",),"EMOJI_VEGGIE 4500 33000 10 25 filler Boosts_the_bonus_of_all_golden_food_by_+{% 480000 40 5500000 60 12000000000.0 80".split(" ",),"VIP_PARCHMENT 6300 42000 10 25 filler Boosts_VIP_Membership_in_the_library_by_+{% 520000 50 6700000 100 25000000000.0 150".split(" ",),"DREAM_CATCHER 7000 50000 1 2 filler Boosts_all_Skill_AFK_gain_rates_by_+{% 560000 4 8200000 10 40000000000.0 15".split(" ",),"DUSTER_STUDS 8000 60000 3 7 filler Boosts_weapon_power_by_+{ 600000 15 10000000 25 60000000000.0 40".split(" ",),"GARLIC_GLOVE 9000 70000 15 35 filler Decreases_the_cost_of_all_kitchen_upgrades_by_-{% 650000 60 12000000 90 100000000000.0 95".split(" ",),"LAB_TESSTUBE 12000 80000 8 20 filler Boosts_Lab_EXP_gain_by_+{% 700000 35 14000000 70 200000000000.0 100".split(" ",),"PECULIAR_VIAL 17000 120000 15 25 filler Boosts_the_regeneration_rate_of_all_alchemy_liquids_by_+{% 750000 35 15000000 50 350000000000.0 65".split(" ",),"LOOT_PILE 23000 160000 10 20 filler All_sailing_treasure_chests_give_+{%_more_treasure! 900000 30 16000000 60 500000000000.0 100".split(" ",),"DIV_SPIRAL 26000 200000 10 30 filler Boosts_Divinity_EXP_gain_by_+{% 1200000 50 17000000 100 700000000000.0 150".split(" ",),"COOL_COIN 30000 250000 20 50 filler Boosts_Jade_Coin_gain_in_Sneaking_by_+{% 2000000 100 20000000 250 1000000000000.0 400".split(" ",),]
