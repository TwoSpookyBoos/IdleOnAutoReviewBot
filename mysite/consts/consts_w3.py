...
#`if ("PowerPerCycle" == e)` in source. Last updated in v2.528.0
...
# see `TalentEnhDisp` in source (Amount of bonuses * 25). Last updated in v2.528.0
...
apocable_map_index_dict = {
    ...
    7: [301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 315, 316, 317, 318, 319, 320, 321, 322, 323, 325, 326]
}
...
#`EquipmentSets = function ()` in source. Last updated in v2.528.0
equipment_sets_dict = {
    'COPPER_SET': [
