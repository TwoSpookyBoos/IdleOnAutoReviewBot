...
def getProgressionTiersAdviceGroup(max_tier: int):
    building_AdviceDict = {}
    ...
    tier_UnlockAllBuildings = all([building['Level'] > 0 for building in playerBuildings.values()])
    ...
    return building_AdviceGroupDict, tier_UnlockAllBuildings
...
def getConsBuildingsAdviceSection() -> AdviceSection:
    ...
    #Generate AdviceGroups
    building_AdviceGroupDict, tier_UnlockAllBuildings = getProgressionTiersAdviceGroup(max_tier)

    #Generate AdviceSection
    overall_BuildingsTier = min(max_tier + info_tiers, tier_UnlockAllBuildings)
    tier_section = f"{overall_BuildingsTier}/{max_tier}"
    building_AdviceSection = AdviceSection(
        name="Buildings",
        tier=tier_section,
        pinchy_rating=overall_BuildingsTier,
