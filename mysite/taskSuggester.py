...
from general import combatLevels, greenstacks, pinchy, cards, secretPath, consumables, gemShop, active, achievements, eventShop, dropRate
...
def main(inputData, source_string, runType="web"):
    ...
    all_sections = [
        sections_general := [
            ...
            dropRate.getDropRateAdviceSection(),
