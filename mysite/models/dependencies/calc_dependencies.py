...
def calc_dependencies():
    return {
        ...
        _calculate_caverns_monuments_bravery: [_calculate_caverns_measurements_base, _calculate_caverns_measurements_multis],
        _calculate_caverns_monuments_justice: [],
        _calculate_caverns_motherlode_layers: [_calculate_caverns_studies],
        ...
        _calculate_general_crystal_spawn_chance: [_calculate_w1_stamps, _calculate_general_character_bonus_talent_levels],
        _calculate_general_guild_bonuses: [],
        _calculate_general_highest_world_reached: [],
        _calculate_general_item_filter: [],
        _calculate_master_classes_compass_dust_sources: [_calculate_master_classes_compass_upgrades, _calculate_w6_emperor],
        _calculate_master_classes_compass_upgrades: [],
        _calculate_master_classes_grimoire_bone_sources: [_calculate_master_classes_grimoire_upgrades, _calculate_w6_emperor],
        _calculate_master_classes_grimoire_upgrades: [],
        _calculate_master_classes_tesseract_tachyon_sources: [_calculate_master_classes_tesseract_upgrades, _calculate_w6_emperor],
        ...
        _calculate_w3_collider_cost_reduction: [_calculate_w1_stamps, _calculate_master_classes_grimoire_upgrades, _calculate_w3_collider_base_costs],
        _calculate_w3_equinox_max_levels: [],
        _calculate_w3_library_max_book_levels: [_calculate_w6_summoning_winner_bonuses],
        _calculate_w3_shrine_advices: [_calculate_w3_shrine_values],
        _calculate_w3_shrine_values: [],
        _calculate_w4_cooking_max_plate_levels: [],
        _calculate_w4_jewel_multi: [],
        _calculate_w4_lab_bonuses: [],
        _calculate_w4_meal_multi: [_calculate_w3_armor_sets, _calculate_w6_summoning_winner_bonuses, _calculate_w4_jewel_multi],
        _calculate_w4_tome: [],
        ...
        _calculate_w6_farming_crop_depot: [_calculate_master_classes_grimoire_upgrades, _calculate_w4_jewel_multi],
        _calculate_w6_farming_crop_evo: [_calculate_w2_vials, _calculate_w1_stamps, _calculate_w6_summoning_winner_bonuses, _calculate_w1_starsigns, _calculate_w6_farming_land_ranks, _calculate_w2_ballot],
        _calculate_w6_farming_crop_speed: [_calculate_w6_summoning_winner_bonuses, _calculate_w2_vials],
        _calculate_w6_farming_crop_value: [_calculate_w2_ballot, _calculate_w6_farming_land_ranks],
