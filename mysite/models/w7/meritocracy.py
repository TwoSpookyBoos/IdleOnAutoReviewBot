...
from utils.safer_data_handling import safer_index, safer_get, safe_loads
...
class Meritocracy(list[MeritocracyBonus]):
    def __init__(self, raw_data: dict):
        ...
        # a.engine.getGameAttribute("OptionsListAccount")[451] is the week in which the
        # player voted in meritocracy. Near this expression found how week calculated.
        raw_time_away = safe_loads(raw_data.get("TimeAway", {}))
        global_time = safer_get(raw_time_away, "GlobalTime", 0)
        self._week = math.floor((global_time + meritocracy_week_time_offset) / 604800)
        # calculate by hand to know current week
